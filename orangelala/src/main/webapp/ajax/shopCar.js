		        ...
		        success: function (data)
		        {
		        	if(data.status==200){
						...
						'<div class="bundle  bundle-last ">'+
							'<div class="bundle-hd">'+
								'<div class="bd-promos">'+
									'<div class="bd-has-promo">已享优惠:<span class="bd-has-promo-content">省￥'+data.data.items[i].price/100*0.1+'</span>&nbsp;&nbsp;</div>'+
									'<div class="act-promo">'+
							...
							'<div class="bundle-main">'+
								'<ul class="item-content clearfix">'+
										...
										'<div class="item-price price-promo-promo">'+
											'<div class="price-content">'+
												'<div class="price-line">'+
													'<em class="price-original">'+data.data.items[i].price*1.2/100+'</em>'+
												'</div>'+   
												'<div class="price-line">'+
													'<em class="J_Price price-now" tabindex="0">'+data.data.items[i].price/100+'</em>'+
												'</div>'+
											'</div>'+
										'</div>'+
									'</li>  '+
									...
									'<li class="td td-sum">'+
										'<div class="td-inner">'+
											'<em tabindex="0" class="J_ItemSum number">'+data.data.items[i].price/100*data.data.catItems[i].number+'</em>'+
										'</div>'+
									'</li>'+
									'<li class="td td-op">'+
										'<div class="td-inner">'+
                 ...
                 ' 删除</a>'+
					...
					'</tr>');
		        		...
		        		$(".delete").click(function(){  
		        			var id = $(this).parent().parent().parent().parent().parent().prev().val();   
		        			window.location.replace("http://localhost:8080/orangelala/deleteCarItemById.html?id="+id);
		        		})
		        	}else{
		        		//载入缓存失败图片
	//	        		var div = $(".ml-22");
