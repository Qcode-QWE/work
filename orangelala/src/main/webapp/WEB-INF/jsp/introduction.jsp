...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<link type="text/css" href="${pageContext.request.contextPath}/css/pshow.css" rel="stylesheet" />
		<link type="text/css" href="${pageContext.request.contextPath}/css/taotao.css" rel="stylesheet" />
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/ajax/commons_search.js"></script>
	...
	<body>
		<input id="itemId" value="${ItemId }" hidden="true"/>
				...
				<div class="item-inform">
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310" id="thumbMax">
					...
					<div class="clearfixRight">
						...
						<!--规格属性-->
						<!--名称-->
						<div class="tb-detail-hd" id="item-title">
							<h1>	
						...
						<div class="tb-detail-list">
							...
							<div class="tb-detail-price">
								...
								<li class="price iteminfo_mktprice">
									<dt>原价</dt>
									<dd><em>¥</em><b class="sys_item_mktprice" id="sys_item_mktprice">98.00</b></dd>									
								</li>
								<div class="clear"></div>
							</div>
							...
							<dl class="iteminfo_parameter freight">
								...
								<!-- <div class="iteminfo_freprice">
									<div class="am-form-content address">
										<select data-am-selected id="s_province" name="s_province">
											<option value="a">浙江省</option>
											<option value="b">湖北省</option>
										</select>
										<select data-am-selected id="s_city" name="s_city">
											<option value="a">温州市</option>
											<option value="b">武汉市</option>
										</select>
										<select data-am-selected id="s_county" name="s_county">
												...
												<div class="theme-signin-left">
													...
													<div class="theme-options">
														...
														<dd>
															...
															<span id="Stock" class="tb-hidden">库存<span class="stock" id="stock_num">1000</span>件</span>
														</dd>
							...
							<div class="am-tabs-bd">
								...
								<div class="am-tab-panel am-fade am-in am-active">
									...
									<div class="details">
										...
										<div class="twlistNews" id="twlistNews">
